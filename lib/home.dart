              ...
              child: ListView(
                children: [
                  Card(
                    ...
                    child: ListTile(contentPadding: EdgeInsets.all(20), title: Text('Informasi SBMPTN', style: TextStyle(fontSize: 16)), subtitle: Text('Dapatkan Informasi SBMPTN Disini'), leading: CircleAvatar(backgroundColor: Colors.green, child: Icon(Icons.notifications))),
                  ),
                  Card(
                    margin: EdgeInsets.all(15),
                    color: Color.fromRGBO(104, 164, 136, 100),
                    shadowColor: Colors.black,
                    child: ListTile(contentPadding: EdgeInsets.all(20), title: Text('Jadwal SBMPTN', style: TextStyle(fontSize: 16)), subtitle: Text('Dapatkan Jadwal SBMPTN Disini'), leading: CircleAvatar(backgroundColor: Colors.green, child: Icon(Icons.notifications))),
                  ),
                  Card(
                    margin: EdgeInsets.all(15),
                    color: Color.fromRGBO(104, 164, 136, 100),
